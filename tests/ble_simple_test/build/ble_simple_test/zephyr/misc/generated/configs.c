...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 11);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 14);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_GROMBOARD_MINEWSEMI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_GROMBOARD_MINEWSEMI_NRF54L15_CPUAPP, 1);
